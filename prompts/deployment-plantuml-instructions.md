...
4. ✅ Все вложенные элементы имеют правильные отступы (2 пробела на уровень)
5. ✅ Используются строгие цвета (белый, черный, серый) через skinparam
6. ✅ Нет специальных символов в названиях элементов, которые могут сломать синтаксис
7. ✅ Все названия на русском языке
8. ✅ Все скобки правильно закрыты
9. ✅ Все стрелки правильно оформлены
...
6. ✅ Нет специальных символов в названиях элементов?
7. ✅ Все названия на русском языке?
8. ✅ Все скобки правильно закрыты?
9. ✅ Все стрелки правильно оформлены?
10. ✅ Код можно скопировать и вставить в PlantUML редактор БЕЗ ОШИБОК?
...
4. ✅ ОБЯЗАТЕЛЬНО добавляй стили для строгих цветов (белый, черный, серый) через skinparam
5. ✅ Используй русские названия
6. ✅ Избегай специальных символов в названиях элементов
7. ✅ Проверяй код перед отправкой
8. ✅ Используй правильные типы элементов (node, database, component, artifact, etc.)
9. ✅ Используй правильные типы стрелок (-->, ..>, <--, <.., etc.)
10. ✅ Всегда проверяй уникальность имен элементов
...
4. ❌ НЕ используй табуляцию для отступов (используй пробелы!)
...
7. ❌ НЕ используй кавычки или скобки в названиях элементов (кроме случаев, когда они нужны для названий с пробелами)
8. ❌ НЕ используй английские названия для элементов
9. ❌ НЕ отправляй код без проверки
10. ❌ НЕ забывай закрывать все скобки
