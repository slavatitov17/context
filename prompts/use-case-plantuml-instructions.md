...
5. ✅ Все связи имеют правильные типы стрелок (`-->`, `.>`, `..>`, `--|>`)?
6. ✅ Все пакеты (rectangle) имеют правильные отступы?
7. ✅ Содержимое внутри пакетов имеет отступ (минимум +2 пробела)?
8. ✅ Закрывающие скобки `}` на том же уровне отступа, что и открывающие?
9. ✅ **НЕТ АЛИАСОВ ВНУТРИ ПАКЕТОВ?** Все варианты использования внутри пакетов определены с полными названиями в скобках `(Название)`, а не через алиасы типа `UC1`?
10. ✅ Добавлены стили для строгих цветов через `skinparam`?
11. ✅ Нет специальных символов в названиях?
...
3. ✅ Всегда используй круглые скобки `()` для вариантов использования
4. ✅ Всегда используй правильные типы стрелок (`-->`, `.>`, `..>`, `--|>`)
5. ✅ **НЕ ИСПОЛЬЗУЙ АЛИАСЫ ВНУТРИ ПАКЕТОВ!** Все варианты использования внутри пакетов определяй с полными названиями в скобках `(Название)`
6. ✅ ОБЯЗАТЕЛЬНО добавляй стили для строгих цветов через `skinparam`
7. ✅ Используй русские названия
8. ✅ Избегай специальных символов в названиях
...
6. ❌ **НЕ ИСПОЛЬЗУЙ АЛИАСЫ ВНУТРИ ПАКЕТОВ!** Если вариант использования определен с алиасом вне пакета, определи его заново внутри пакета с полным названием в скобках `(Название)`
7. ❌ НЕ используй яркие цвета (зеленый, желтый, фиолетовый) - ТОЛЬКО белый, черный, серый!
8. ❌ НЕ забывай добавлять стили для строгих цветов
9. ❌ НЕ используй кавычки или скобки в названиях (кроме случаев, когда они нужны)
10. ❌ НЕ используй английские названия для акторов и вариантов использования
