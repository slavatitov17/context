...
7. После кода диаграммы, добавь глоссарий в формате JSON массива объектов с полями "element" и "description"`;
    ...
    const diagramTypeDescriptions: Record<string, string> = {
      ...
      'JSONPlantUML': 'JSON диаграмма (PlantUML) - Максимально качественная версия',
...
\`\`\``;
      ...
      // Загружаем инструкции для MindMapPlantUML, SequencePlantUML и UseCasePlantUML из файлов
      ...
      if (diagramType === 'MindMapPlantUML') {
        ...
        try {
          ...
          console.error('Ошибка при чтении инструкций для JSONPlantUML:', error);
          plantUmlInstructions = 'ДЛЯ JSON PLANTUML: Используй правильный синтаксис @startjson ... @endjson. JSON должен быть валидным с правильными отступами (2 пробела на уровень вложенности). Все ключи и строки в двойных кавычках. ОБЯЗАТЕЛЬНО добавляй стили для строгих цветов (белый, черный, серый) через <style> блок!';
        }
      }
...
`;
          ...
          // Для UseCasePlantUML: добавляем стили для строгих цветов, если их нет
...
`;
          ...
          // Для Class и ClassPlantUML: исправляем длинные названия классов без пробелов
          ...
          // Для ClassPlantUML: добавляем стили для строгих цветов, если их нет
...
`;
          ...
          // Для ComponentPlantUML: добавляем стили для строгих цветов, если их нет
...
`;
          ...
          // Для GanttPlantUML: добавляем стили для строгих цветов, если их нет
...
`;
          ...
          // Для JSONPlantUML: добавляем стили для строгих цветов, если их нет
...
{
  "название": "${objectDescription.split(' ')[0]}",
  "описание": "${objectDescription.substring(0, 50)}",
  "тип": "объект",
  "свойства": {
    "свойство1": "значение1",
    "свойство2": "значение2"
