            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div className="relative">
                <select
                  ...
                  className={`border rounded-lg p-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent min-w-[160px] appearance-none pr-10 h-[48px] ${isDark ? 'bg-gray-600 border-gray-500 text-gray-100' : 'bg-white border-gray-300 text-gray-900'}`}
                >
