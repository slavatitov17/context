...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'graphicEditor.print.title': 'Печать',
    'graphicEditor.print.printer': 'Принтер',
    'graphicEditor.print.printAll': 'Печать всех листов',
    'graphicEditor.print.printSheets': 'Листы:',
    'graphicEditor.print.sheetsInputAria': 'Номера листов',
    'graphicEditor.print.submit': 'Печать',
    'graphicEditor.print.cancel': 'Отмена',
    'graphicEditor.print.printerDefault': 'По умолчанию (в диалоге системы)',
    'graphicEditor.print.printerHint': 'Точный выбор принтера выполняется в окне печати браузера.',
    'graphicEditor.print.sheetsError': 'Введите целое число от 1 до {max}.',
  ...
  en: {
    ...
    'graphicEditor.print.title': 'Print',
    'graphicEditor.print.printer': 'Printer',
    'graphicEditor.print.printAll': 'Print all sheets',
    'graphicEditor.print.printSheets': 'Sheets:',
    'graphicEditor.print.sheetsInputAria': 'Sheet numbers',
    'graphicEditor.print.submit': 'Print',
    'graphicEditor.print.cancel': 'Cancel',
    'graphicEditor.print.printerDefault': 'Default (choose in system dialog)',
    'graphicEditor.print.printerHint': 'The exact printer is selected in the browser print dialog.',
    'graphicEditor.print.sheetsError': 'Enter a whole number from 1 to {max}.',
