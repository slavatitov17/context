...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'version.diagrams.item5': 'Иерархическая структура работ (WBS)',
    ...
    'project.createDiagram': 'Создать диаграмму',
    ...
    'diagram.edit.title': 'Редактирование диаграммы',
    'diagram.edit.subtitle': 'Измените информацию о диаграмме',
    'diagram.edit.requiredFields': '* - обязательные поля',
    'diagram.edit.name': 'Название диаграммы',
    'diagram.edit.namePlaceholder': 'Введите название диаграммы...',
    'diagram.edit.description': 'Краткое описание диаграммы',
    'diagram.edit.descriptionPlaceholder': 'Введите описание диаграммы...',
    'diagram.edit.cancel': 'Отмена',
    'diagram.edit.save': 'Сохранить',
    'diagram.edit.saving': 'Сохранение...',
    ...
    'diagram.copyGlossary': 'Скопировать',
    'diagram.copy': 'Скопировать',
    'diagram.glossaryCopied': 'Глоссарий скопирован',
    'diagram.export': 'Выгрузить',
    'diagram.exportWord': 'Word',
    'diagram.exportExcel': 'Excel',
    ...
    'diagram.type.Sequence.description': 'Диаграмма последовательности отображает взаимодействие объектов во времени через обмен сообщениями между участниками системы и последовательность вызовов',
    'diagram.type.UseCase.description': 'Диаграмма вариантов использования описывает функциональные требования системы через взаимодействие актеров и прецедентов использования с указанием границ',
    'diagram.type.Class.description': 'Диаграмма классов показывает структуру системы через классы, их атрибуты, методы и связи между ними, включая наследование и композицию',
    'diagram.type.Object.description': 'Диаграмма объектов отображает конкретные экземпляры классов и их связи в определенный момент времени выполнения системы с указанием значений',
    'diagram.type.Activity.description': 'Диаграмма деятельности моделирует бизнес-процессы и потоки работ, показывая последовательность действий, принятие решений и параллельные потоки',
    'diagram.type.Component.description': 'Диаграмма компонентов показывает архитектуру системы и её компоненты с указанием интерфейсов, зависимостей и способов взаимодействия между ними',
    'diagram.type.Deployment.description': 'Диаграмма развертывания отображает физическую архитектуру системы, показывая размещение компонентов на узлах развертывания и связи между ними',
    'diagram.type.Statechart.description': 'Диаграмма состояний моделирует жизненный цикл объектов и их состояния, показывая переходы между состояниями, условия перехода и действия',
    'diagram.type.Gantt.description': 'Диаграмма Ганта визуализирует временные рамки проекта и задачи, показывая длительность, зависимость, последовательность выполнения работ и ресурсы',
    'diagram.type.MindMap.description': 'Интеллект-карта представляет идеи и концепции в иерархической структуре, показывая связи между понятиями, их взаимное расположение и группировку',
    'diagram.mindMapCanva.inDevelopment': 'Тип диаграммы в разработке',
    'graphicEditor.ribbon.file': 'Файл',
    'graphicEditor.ribbon.layout': 'Макет',
    'graphicEditor.ribbon.insert': 'Вставка',
    'graphicEditor.ribbon.format': 'Формат',
    'graphicEditor.ribbon.toolbar': 'Панель инструментов',
    'graphicEditor.collection': 'Коллекция',
    'graphicEditor.format.color': 'Цвет',
    'graphicEditor.format.width': 'Ширина',
    'graphicEditor.format.height': 'Высота',
    'graphicEditor.format.sizeLabel': 'Размер',
    'graphicEditor.format.scale': 'Масштаб',
    'graphicEditor.format.bgColor': 'Фон',
    'graphicEditor.format.textColor': 'Цвет текста',
    'graphicEditor.format.textColorBtn': 'Текст',
    'graphicEditor.format.font': 'Шрифт',
    'graphicEditor.format.otherBlock': 'Другое',
    'graphicEditor.format.deleteItem': 'Удалить',
    'graphicEditor.format.duplicateItem': 'Дублировать',
    'graphicEditor.format.emptySheetLead': 'Нет добавленных элементов.',
    'graphicEditor.format.emptySheetLink': 'Добавить',
    'graphicEditor.format.selectItemHint': 'Выберите элемент на листе.',
    'graphicEditor.ai.openChat': 'Генерация диаграммы',
    'graphicEditor.ai.title': 'Генерация диаграммы',
    'graphicEditor.ai.close': 'Закрыть',
    'graphicEditor.ai.initialMessage': 'Опишите объект, диаграмму которого необходимо построить.',
    'graphicEditor.ai.placeholder': 'Опишите объект или тему…',
    'graphicEditor.ai.send': 'Отправить',
    'graphicEditor.ai.you': 'Вы',
    'graphicEditor.ai.assistant': 'Ассистент',
    'graphicEditor.ai.successReply': 'Диаграмма на листе обновлена по вашему описанию.',
    'graphicEditor.ai.errorGeneric': 'Не удалось сгенерировать диаграмму.',
    'graphicEditor.ai.errorEmpty': 'Модель не вернула элементы для листа.',
    'graphicEditor.ai.hint.title': 'Генерация диаграммы',
    'graphicEditor.ai.hint.text': 'В окне чата введите объект, диаграмму которого нужно создать',
    'graphicEditor.ai.hint.dontShowAgain': 'Больше не показывать',
    'graphicEditor.ai.fromProject.documentsProcessed': 'Обработаны документы:',
    'graphicEditor.ai.fromProject.enterObject': 'Введите объект, по которому нужно создать диаграмму.',
    'graphicEditor.insert.element': 'Элемент',
    'graphicEditor.insert.text': 'Текст',
    'graphicEditor.insert.newElement': 'Новый элемент',
    'graphicEditor.insert.elementTextareaPlaceholder': 'Новый текст',
    'graphicEditor.insert.textPlaceholder': 'Текст',
    'graphicEditor.font.sans': 'Без засечек',
    'graphicEditor.font.serif': 'С засечками',
    'graphicEditor.font.mono': 'Моноширинный',
    'graphicEditor.close': 'Закрыть',
    'graphicEditor.layout.orientation': 'Ориентация',
    'graphicEditor.orientation.portrait': 'Вертикальная',
    'graphicEditor.orientation.landscape': 'Альбомная',
    'graphicEditor.layout.scale': 'Масштаб',
    'graphicEditor.zoom.in': 'Приблизить',
    'graphicEditor.zoom.out': 'Отдалить',
    'graphicEditor.diagramTypeName': 'MindMap (Editor)',
    'graphicEditor.layout.grid': 'Сетка',
    'graphicEditor.grid.cells': 'Клетки',
    'graphicEditor.grid.dots': 'Точки',
    'graphicEditor.file.export': 'Экспорт',
    'graphicEditor.file.changes': 'Изменения',
    'graphicEditor.changes.undo': 'Отменить',
    'graphicEditor.changes.redo': 'Вернуть',
    'graphicEditor.file.other': 'Другое',
    'graphicEditor.export.pdf': 'PDF',
    'graphicEditor.export.word': 'Word',
    'graphicEditor.export.png': 'PNG',
    'graphicEditor.other.print': 'Печать',
    'graphicEditor.other.save': 'Сохранить',
    'graphicEditor.save.toast': 'Изменения сохранены',
  ...
  en: {
    ...
    'version.diagrams.item5': 'Work Breakdown Structure (WBS)',
    ...
    'project.createDiagram': 'Create diagram',
    ...
    'diagram.edit.title': 'Edit Diagram',
    'diagram.edit.subtitle': 'Change diagram information',
    'diagram.edit.requiredFields': '* - required fields',
    'diagram.edit.name': 'Diagram Name',
    'diagram.edit.namePlaceholder': 'Enter diagram name...',
    'diagram.edit.description': 'Brief Description',
    'diagram.edit.descriptionPlaceholder': 'Enter diagram description...',
    'diagram.edit.cancel': 'Cancel',
    'diagram.edit.save': 'Save',
    'diagram.edit.saving': 'Saving...',
    ...
    'diagram.copyGlossary': 'Copy',
    'diagram.copy': 'Copy',
    'diagram.glossaryCopied': 'Glossary copied',
    ...
    'diagram.mindMapCanva.inDevelopment': 'This diagram type is under development',
    'graphicEditor.ribbon.file': 'File',
    'graphicEditor.ribbon.layout': 'Layout',
    'graphicEditor.ribbon.insert': 'Insert',
    'graphicEditor.ribbon.format': 'Format',
    'graphicEditor.ribbon.toolbar': 'Toolbar',
    'graphicEditor.collection': 'Collection',
    'graphicEditor.format.color': 'Color',
    'graphicEditor.format.width': 'Width',
    'graphicEditor.format.height': 'Height',
    'graphicEditor.format.sizeLabel': 'Size',
    'graphicEditor.format.scale': 'Scale',
    'graphicEditor.format.bgColor': 'Background',
    'graphicEditor.format.textColor': 'Text color',
    'graphicEditor.format.textColorBtn': 'Text',
    'graphicEditor.format.font': 'Font',
    'graphicEditor.format.otherBlock': 'Other',
    'graphicEditor.format.deleteItem': 'Delete',
    'graphicEditor.format.duplicateItem': 'Duplicate',
    'graphicEditor.format.emptySheetLead': 'No items on the sheet yet.',
    'graphicEditor.format.emptySheetLink': 'Add',
    'graphicEditor.format.selectItemHint': 'Select an item on the sheet.',
    'graphicEditor.ai.openChat': 'Diagram generation',
    'graphicEditor.ai.title': 'Diagram generation',
    'graphicEditor.ai.close': 'Close',
    'graphicEditor.ai.initialMessage': 'Describe the subject you want a mind map diagram for.',
    'graphicEditor.ai.placeholder': 'Describe the topic or object…',
    'graphicEditor.ai.send': 'Send',
    'graphicEditor.ai.you': 'You',
    'graphicEditor.ai.assistant': 'Assistant',
    'graphicEditor.ai.successReply': 'The sheet diagram was updated from your description.',
    'graphicEditor.ai.errorGeneric': 'Could not generate the diagram.',
    'graphicEditor.ai.errorEmpty': 'The model returned no items for the sheet.',
    'graphicEditor.ai.hint.title': 'Diagram generation',
    'graphicEditor.ai.hint.text': 'In the chat window, enter the subject of the diagram you want to create',
    'graphicEditor.ai.hint.dontShowAgain': 'Don\'t show again',
    'graphicEditor.ai.fromProject.documentsProcessed': 'Documents processed:',
    'graphicEditor.ai.fromProject.enterObject': 'Enter the object you want the diagram to be built for.',
    'graphicEditor.insert.element': 'Element',
    'graphicEditor.insert.text': 'Text',
    'graphicEditor.insert.newElement': 'New element',
    'graphicEditor.insert.elementTextareaPlaceholder': 'New text',
    'graphicEditor.insert.textPlaceholder': 'Text',
    'graphicEditor.font.sans': 'Sans-serif',
    'graphicEditor.font.serif': 'Serif',
    'graphicEditor.font.mono': 'Monospace',
    'graphicEditor.close': 'Close',
    'graphicEditor.layout.orientation': 'Orientation',
    'graphicEditor.orientation.portrait': 'Portrait',
    'graphicEditor.orientation.landscape': 'Landscape',
    'graphicEditor.layout.scale': 'Scale',
    'graphicEditor.zoom.in': 'Zoom in',
    'graphicEditor.zoom.out': 'Zoom out',
    'graphicEditor.diagramTypeName': 'MindMap (Editor)',
    'graphicEditor.layout.grid': 'Grid',
    'graphicEditor.grid.cells': 'Grid lines',
    'graphicEditor.grid.dots': 'Dots',
    'graphicEditor.file.export': 'Export',
    'graphicEditor.file.changes': 'Changes',
    'graphicEditor.changes.undo': 'Undo',
    'graphicEditor.changes.redo': 'Redo',
    'graphicEditor.file.other': 'Other',
    'graphicEditor.export.pdf': 'PDF',
    'graphicEditor.export.word': 'Word',
    'graphicEditor.export.png': 'PNG',
    'graphicEditor.other.print': 'Print',
    'graphicEditor.other.save': 'Save',
    'graphicEditor.save.toast': 'Changes saved',
