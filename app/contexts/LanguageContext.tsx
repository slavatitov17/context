...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'graphicEditor.exitEditor': 'Выйти из редактора',
    ...
    'graphicEditor.closeDiagram': 'Закрыть диаграмму',
  ...
  en: {
    ...
    'graphicEditor.exitEditor': 'Exit editor',
    ...
    'graphicEditor.diagramTypeName': 'MindMap (Editor)',
    'graphicEditor.closeDiagram': 'Close diagram',
